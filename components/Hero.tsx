        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 md:p-12 shadow-lg border border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-12">
            ...
            <div className="flex-1 text-center md:text-left space-y-4">
              ...
              <p className="text-base md:text-lg text-gray-500 dark:text-gray-400 italic">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3 pt-2">
                <a
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:scale-105 transition-transform text-sm font-medium border border-gray-300 dark:border-gray-600"
                  aria-label="Email"
                >
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-10 mt-2">
